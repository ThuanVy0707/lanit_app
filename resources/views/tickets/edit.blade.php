                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select id="department" name="department" required
                                    ...
                                    <option value="Support" {{ old('department', $ticket->department) === 'Support' ? 'selected' : '' }}>Support</option>
                                    <option value="Sales" {{ old('department', $ticket->department) === 'Sales' ? 'selected' : '' }}>Sales</option>
                                    <option value="Billing" {{ old('department', $ticket->department) === 'Billing' ? 'selected' : '' }}>Billing</option>
                                    <option value="Technical" {{ old('department', $ticket->department) === 'Technical' ? 'selected' : '' }}>Technical</option>
                                </select>
                                @error('department')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select id="status" name="status" required
                                    ...
                                    <option value="Merged" {{ old('status', $ticket->status) === 'Merged' ? 'selected' : '' }}>Merged</option>
                                </select>
                                @error('status')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
