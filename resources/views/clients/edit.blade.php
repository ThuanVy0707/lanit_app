                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="status" id="status"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="Active" {{ old('status', $client->status) === 'Active' ? 'selected' : '' }}>{{ __('messages.msg_active') }}</option>
                                    <option value="Inactive" {{ old('status', $client->status) === 'Inactive' ? 'selected' : '' }}>{{ __('messages.msg_inactive') }}</option>
                                    <option value="Closed" {{ old('status', $client->status) === 'Closed' ? 'selected' : '' }}>{{ __('messages.msg_closed') }}</option>
                                </select>
                                @error('status')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="source" id="source"
                                    ...
                                    <option value="Website" {{ old('source', $client->source) === 'Website' ? 'selected' : '' }}>{{ __('messages.msg_website') }}</option>
                                    <option value="Referral" {{ old('source', $client->source) === 'Referral' ? 'selected' : '' }}>{{ __('messages.msg_referral') }}</option>
                                    <option value="Social Media" {{ old('source', $client->source) === 'Social Media' ? 'selected' : '' }}>{{ __('messages.msg_social_media') }}</option>
                                    <option value="Advertisement" {{ old('source', $client->source) === 'Advertisement' ? 'selected' : '' }}>{{ __('messages.msg_advertisement') }}</option>
                                    <option value="Partner" {{ old('source', $client->source) === 'Partner' ? 'selected' : '' }}>{{ __('messages.msg_partner') }}</option>
                                    <option value="Direct" {{ old('source', $client->source) === 'Direct' ? 'selected' : '' }}>{{ __('messages.msg_direct') }}</option>
                                    <option value="Other" {{ old('source', $client->source) === 'Other' ? 'selected' : '' }}>{{ __('messages.msg_other') }}</option>
                                </select>
                                @error('source')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <!-- Credit -->
                            <div>
                                <label for="credit" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.msg_credit_balance') }}</label>
