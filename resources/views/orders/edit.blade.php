                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('orders.update', $order) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select name="payment_status" id="payment_status" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="Pending" {{ old('payment_status', $order->payment_status) === 'Pending' ? 'selected' : '' }}>{{ __('messages.msg_pending') }}</option>
                                    <option value="Paid" {{ old('payment_status', $order->payment_status) === 'Paid' ? 'selected' : '' }}>{{ __('messages.msg_paid') }}</option>
                                    <option value="Cancelled" {{ old('payment_status', $order->payment_status) === 'Cancelled' ? 'selected' : '' }}>{{ __('messages.msg_cancelled') }}</option>
                                    <option value="Refunded" {{ old('payment_status', $order->payment_status) === 'Refunded' ? 'selected' : '' }}>{{ __('messages.msg_refunded') }}</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="Pending" {{ old('status', $order->status) === 'Pending' ? 'selected' : '' }}>{{ __('messages.msg_pending') }}</option>
                                    <option value="Active" {{ old('status', $order->status) === 'Active' ? 'selected' : '' }}>{{ __('messages.msg_active') }}</option>
                                    <option value="Cancelled" {{ old('status', $order->status) === 'Cancelled' ? 'selected' : '' }}>{{ __('messages.msg_cancelled') }}</option>
                                    <option value="Fraud" {{ old('status', $order->status) === 'Fraud' ? 'selected' : '' }}>{{ __('messages.msg_fraud') }}</option>
                                    <option value="Completed" {{ old('status', $order->status) === 'Completed' ? 'selected' : '' }}>{{ __('messages.msg_completed') }}</option>
                                </select>
                                @error('status')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="mb-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                            <h4 class="text-md font-semibold mb-3">{{ __('messages.msg_fraud_detection_optional') }}</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="fraud_module" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.msg_fraud_module') }}</label>
                                ...
                                <div>
                                    <label for="fraud_output" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.msg_fraud_output') }}</label>
